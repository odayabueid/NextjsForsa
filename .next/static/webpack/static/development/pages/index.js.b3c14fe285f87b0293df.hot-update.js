...
function (_Component) {
  ...
  function LogIn() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "logInForm", function (e) {
      ...
      e.preventDefault();
      var data = {};
      data.first_name = _this.state.email;
      data.first_name = _this.state.password;
      ...
      if (_this.state.email.trim() !== "" && _this.state.password.trim() !== "") {
        axios__WEBPACK_IMPORTED_MODULE_18___default.a.post("https://api.for9a.com/u/login", data).then(function (res) {
          console.log(res);
          console.log(res.data.user.id, "saaaaaaaaaaaa"); // this.redirecToJobsCards()
...
//# sourceMappingURL=index.js.b3c14fe285f87b0293df.hot-update.js.map