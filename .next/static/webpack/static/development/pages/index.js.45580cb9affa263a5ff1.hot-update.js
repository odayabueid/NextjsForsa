...
/* harmony import */ var react_spinners__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! react-spinners */ "./node_modules/react-spinners/index.js");
/* harmony import */ var react_spinners__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(react_spinners__WEBPACK_IMPORTED_MODULE_20__);
...
function (_Component) {
  ...
  function SignUp() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "inputHandler", function (name, value) {
      _this.setState(Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])({}, name, value), function () {
        return console.log("stae", _this.state.password);
      });
    });

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "redirecToLogIn", function () {
      next_router__WEBPACK_IMPORTED_MODULE_19___default.a.push('/about');
    });

    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "signUpForm", function (e) {
      _this.setState({
        isLoading: true
      });
      ...
      e.preventDefault();
      var data = {};
      data.first_name = _this.state.firstName;
      data.last_name = _this.state.lastName;
      data.email = _this.state.email;
      data.password = _this.state.password;

      if (_this.state.firstName.trim() !== "" && _this.state.lastName.trim() !== "" && _this.state.email.trim() != "" && _this.state.password.trim() !== "") {
        axios__WEBPACK_IMPORTED_MODULE_18___default.a.post("https://api.for9a.com/u/register", data).then(function (res) {
          console.log(res);

          _this.redirecToLogIn();
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SignUp, [{
    ...
    value: function render() {
      ...
      return __jsx(_material_ui_core_Container__WEBPACK_IMPORTED_MODULE_16__["default"], {
        ...
        __self: this
      }, this.state.emptyField && // <p style={{}}>الرجاء ادخال كامل الحقول للمتابعه</p>
      __jsx("div", {
        ...
        __self: this
      }, "This is a danger alert\u2014check it out!")), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_15__["default"], {
        component: "h1",
        variant: "h4",
        __source: {
          fileName: _jsxFileName,
        ...
        __self: this
      }, "Sign up"), __jsx(_material_ui_core_Avatar__WEBPACK_IMPORTED_MODULE_8__["default"], {
        style: {
          marginTop: "15px"
        },
        __source: {
        ...
        onChange: function onChange() {
          _this2.inputHandler("firstName", event.target.value);
        },
        autoComplete: "fname",
        name: "firstName",
        variant: "outlined",
        ...
        onChange: function onChange() {
          _this2.inputHandler("lastName", event.target.value);
        },
        variant: "outlined",
        required: true,
        fullWidth: true,
        ...
        onChange: function onChange() {
          _this2.inputHandler("email", event.target.value);
        },
        variant: "outlined",
        required: true,
        fullWidth: true,
        ...
        onChange: function onChange() {
          _this2.inputHandler("password", event.target.value);
        },
        variant: "outlined",
        required: true,
        fullWidth: true,
        ...
        __self: this
      }, "Sign Up"), __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_13__["default"], {
        container: true,
        justify: "flex-end",
        __source: {
          fileName: _jsxFileName,
        ...
        __self: this
      }, "Already have an account? Sign in")))), __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_13__["default"], {
        container: true,
        justify: "center",
        __source: {
          fileName: _jsxFileName,
        ...
        __self: this
      }, __jsx(react_spinners__WEBPACK_IMPORTED_MODULE_20__["ClipLoader"], {
        color: "#339eba",
...
//# sourceMappingURL=index.js.45580cb9affa263a5ff1.hot-update.js.map