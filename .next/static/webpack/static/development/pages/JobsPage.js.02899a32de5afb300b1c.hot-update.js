...
function (_Component) {
      ...
      if (event.keyCode === 13 || event.key === "Enter") {
        if (_this.state.jobId.trim() !== "") {
          if (!isNaN(_this.state.jobId)) {
            ...
            console.log("enter num"); //   Alert.error('Test message 3', {
            //     position: 'bottom-right',
            //     effect: 'slide',
            //     timeout: 'none'
            // });

            react_s_alert__WEBPACK_IMPORTED_MODULE_12___default.a.success('Message...', {
              effect: 'genie'
            });
          }
        } else {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(JobsCards, [{
    ...
    value: function render() {
      ...
      }))), __jsx(react_s_alert__WEBPACK_IMPORTED_MODULE_12___default.a, {
        stack: {
          limit: 3
        },
        __source: {
...
//# sourceMappingURL=JobsPage.js.02899a32de5afb300b1c.hot-update.js.map