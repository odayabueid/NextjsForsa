...
function (_Component) {
  ...
  function JobsCards() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "loadMoreJobs", function () {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.get("https://api.for9a.com/opportunity/filter?".concat(_this.state.jobId ? 'id=' + _this.state.jobId : 'id=', "count=").concat(_this.state.limit, "&page=").concat(_this.state.pageNum, "&type=29")).then(function (res) {
...
//# sourceMappingURL=JobsPage.js.71ec4ba60a13e66732bd.hot-update.js.map