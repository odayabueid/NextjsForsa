...
function (_Component) {
  ...
  function CardInfo() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "jobApply", function () {
      var data = {}; // data.job_id=this.props.cardSelected.id
      // data.user_id=this.state.user_id

      data.job_id = "8925";
      data.user_id = "1314";
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.post("https://api.for9a.com/j/apply", data).then(function (res) {
        console.log("res", res);
      })["catch"](function (err) {
        console.log(err);
      });
...
//# sourceMappingURL=jobspage.js.47289b14a52ed38f76ae.hot-update.js.map